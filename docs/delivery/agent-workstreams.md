...
1. `docs/delivery/developer-handoff.md`
2. 本文
...
| Agent 类型 | 必读文档 |
| --- | --- |
| 工程基础 | 全部文档，重点是 `docs/architecture/technical-architecture.md`、`docs/delivery/development-plan.md` |
| 服务端 | `docs/architecture/technical-architecture.md`、`docs/architecture/data-model.md`、`docs/architecture/api-specification.md`、ADR |
| 客户端 | `docs/product/information-architecture.md`、`docs/product/ui-specification.md`、`docs/architecture/api-specification.md` |
| 测试/审查 | `docs/quality/test-plan.md`、`docs/architecture/api-specification.md`、权限相关 ADR |

PRD 用于判断范围，但不包含足够的实现细节。开发 agent 不应只读 `docs/product/product-requirements.md` 就开始编码。
...
客户端可先基于 `docs/architecture/api-specification.md` 使用 mock handler；真实 API 可用后移除 mock，不能在业务组件内散落假数据。
...
```text
Lead Agent：按照 `docs/delivery/current-milestone.md` 执行 M1。先建立 workspace、contracts
